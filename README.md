...
[![logo](src/img/logo-b.webp)](https://github.com/jovezhong/backage)

# [backage](https://github.com/jovezhong/backage)

**It's all part and parcel**

---

[![packages](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fgithub.com%2Fjovezhong%2Fbackage%2Fraw%2Findex%2F.json&query=%24.packages&logo=github&logoColor=959da5&label=packages&labelColor=333a41&color=grey)](https://github.com/jovezhong/backage/tree/index) [![build](https://github.com/jovezhong/backage/actions/workflows/publish.yml/badge.svg)](https://github.com/jovezhong/backage/pkgs/container/backage) [![built](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fgithub.com%2Fjovezhong%2Fbackage%2Fraw%2Findex%2F.json&query=%24.date&logo=github&logoColor=959da5&label=built&labelColor=333a41&color=purple)](https://github.com/jovezhong/backage/releases/latest)
...
If this is [`ipitio/backage`](https://github.com/ipitio/backage), all you have to do is **star the repo to get your public packages added!** The service's circular priority queue will update the [closed-loop system](https://github.com/jovezhong/backage/releases/latest) with them within the next few hours--as long as your profile is set to [public](https://github.com/ipitio/backage/issues/34#issuecomment-2968850773). Additionally watching and forking the repo, and following the owner, are ways to increase their priority. Yes, I know, but these are the graphs GitHub has available.

Otherwise, if this is a fork, you'd prefer an alternative method, or your packages weren't added to the [index](https://github.com/jovezhong/backage/tree/index) after a day, enter the case-sensitive name of each missing user or organization on a new line at the top of `owners.txt` [here](https://github.com/jovezhong/backage/edit/master/owners.txt) and make a pull request. Please submit just the name(s) -- ids, repos, and packages will be found automatically!
...
git clone --depth=1 https://github.com/jovezhong/backage.git
docker run -v $PWD/backage:/app --env-file <(env | grep GITHUB) ghcr.io/jovezhong/backage:master bash src/test/update.sh
```
...
```py
https://github.com/jovezhong/backage/raw/index/OWNER/[REPO/[PACKAGE]].FORMAT
```
...
**<https://ipitio.github.io/backage?json=https://raw.githubusercontent.com/jovezhong/backage/index/.json>**
